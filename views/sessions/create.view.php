...
-->
	<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
		<div class="sm:mx-auto sm:w-full sm:max-w-sm">
			<img src="/assets/CamberdenSignature-min.png" alt="Camberden" class="mx-auto size-40" />
		...
		<div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
				...
				<div>
					...
					<div class="mt-2">
						...
						<?php if (isset($errors["email"])) : ?>
							<p style="color:magenta;"><?= $errors["email"] ?></p>
						<?php endif ?>
				...
				<div>
					...
					<div class="mt-2">
						...
						<?php if (isset($errors["password"])) : ?>
							<p style="color:magenta;"><?= $errors["password"] ?></p>
						<?php endif ?>
			...
			<p class="mt-10 text-center text-sm/6 text-gray-400">
				Not registered?
				<a href="/register" class="font-semibold text-indigo-400 hover:text-indigo-300">Register then.</a>
			</p>
			<p class="mt-6">
				<hr>
				<a href="/" class="text-green-500 hover:underline">Return</a>
			</p>
		</div>
	</div>
